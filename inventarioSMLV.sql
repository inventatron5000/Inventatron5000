...
ALTER TABLE DEPARTAMENTO ADD PRIMARY KEY (Nombre);
...
-- LLAVE PRIMARIA DE AREA
ALTER TABLE AREA ADD PRIMARY KEY (Area);



-- :::::::::::::::TABLA DEPAREA:::::::::::::::
CREATE TABLE DEPAREA (
    Nombre VARCHAR(20),
    Area VARCHAR(20)
);
ALTER TABLE DEPAREA ADD CONSTRAINT depaFK1 FOREIGN KEY (nombre) REFERENCES departamento (nombre) ON UPDATE CASCADE;
ALTER TABLE DEPAREA ADD CONSTRAINT depaFK2 FOREIGN KEY (area) REFERENCES area (area) ON UPDATE CASCADE;
...
ALTER TABLE equipo ADD CONSTRAINT eqFK2 FOREIGN KEY (area) REFERENCES area (area) ON UPDATE CASCADE;
